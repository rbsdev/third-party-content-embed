...
```html
<iframe frameborder="0" scrolling="no" src="path/to/tpce-v0.0.3.html?content=http%3A//example.com/&amp;width=800&amp;height=600"></iframe>
```
...
The `tpce-v0.0.3.html` has the following query string parameters:
